...
;;リマインダー:defstructすると make-構造体の関数が自動的に使えるようになる。
;;ここでは(make-monster)関数
...
(defmethod monster-attack ((m slime-mold))
  (let ((x (randval (slime-mold-sliminess m))))
    ...
    (when (zerop (random 2))
      (princ "It also squirts in your face, taking away a helth point! ")
      (decf *player-health*))))
...
(defmethod monster-attack ((m brigand))
	  (let ((x (max *player-health* *player-agility* *player-strength*)))
	    (cond ((= x *player-health*)
		   (princ "A brigand htis you with his slingshot, taking off 2health points! ")
